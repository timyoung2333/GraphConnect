function [mappedX, mapping] = pca2(X, no_dims, removMean)
%PCA Perform the PCA algorithm
%
%   [mappedX, mapping] = pca(X, no_dims, removMean)
%
...
% 
% Optional input: removMean, if 1, remove mean before performing
% eigen-decomp. default 1.
