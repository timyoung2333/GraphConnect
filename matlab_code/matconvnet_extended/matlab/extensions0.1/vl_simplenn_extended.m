function res = vl_simplenn_extended(net, x, dzdy, res, varargin)
% VL_SIMPLENN  Evaluates a simple CNN
%   RES = VL_SIMPLENN_extended(NET, X) evaluates the convnet NET on data X.
%   RES = VL_SIMPLENN_extended(NET, X, DZDY) evaluates the convnent NET and its
